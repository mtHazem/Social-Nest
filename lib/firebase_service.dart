...
class FirebaseService with ChangeNotifier {
  ...
  Future<void> sendFriendRequest(String friendId) async {
    ...
    try {
      ...
      await sendNotification(
        ...
        message: '${userName ?? "User"} sent you a friend request',
  ...
  Future<void> acceptFriendRequest(String friendId) async {
    ...
    try {
      ...
      await sendNotification(
        ...
        message: '${userName ?? "User"} accepted your friend request',
        senderId: currentUserId,
        senderName: userName ?? "User",
        senderAvatar: userAvatar ?? "U",
      );
  ...
  Future<void> declineFriendRequest(String friendId) async {
    ...
    try {
      ...
      _setError('Failed to decline friend request.');
    } finally {
      _setLoading(false);
    }
  }
  ...
  Future<void> removeFriend(String friendUserId) async {
    ...
    try {
      ...
      final currentUserId = _auth.currentUser!.uid;
      final batch = _firestore.batch();
      batch.delete(_firestore.collection('friends').doc('$currentUserId\_$friendUserId'));
      batch.delete(_firestore.collection('friends').doc('$friendUserId\_$currentUserId'));
