...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  void _navigateToFriendsManagement() {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Do NOT call _signOut() here — only show placeholder if needed
  ...
  // ... (All other helper methods below remain mostly unchanged)
  // Only changes: updated _showQuickMenuBottomSheet and _buildQuickMenuOption
        ...
        SliverAppBar(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: _navigateToFriendsManagement,
                                    child: MouseRegion(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () => _showQuickMenuBottomSheet(firebaseService),
            ),
          ],
        ),
        SliverToBoxAdapter(
  ...
  // ... (All remaining helper methods below unchanged except _showQuickMenuBottomSheet and _buildQuickMenuOption)
  ...
  Widget _buildTabContent(int tabIndex, FirebaseService firebaseService) {
    switch (tabIndex) {
      ...
      case 1:
        return _buildSavedPostsTab(firebaseService);
      case 2:
  ...
  Widget _buildSavedPostsTab(FirebaseService firebaseService) {
    return StreamBuilder<QuerySnapshot>(
      stream: firebaseService.getSavedPosts(),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const SliverToBoxAdapter(
            child: Padding(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'Save interesting posts, study tips, and resources to find them here later!',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Color(0xFF94A3B8),
                    ),
        ...
        return SliverList(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return _buildSavedPostItem(savedData, firebaseService);
            },
  ...
  Widget _buildSavedPostItem(Map<String, dynamic> savedData, FirebaseService firebaseService) {
    return Container(
        ...
        children: [
          ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () => _unsavePost(savedData['postId'], context),
            ),
          ),
          Padding(
  ...
  void _unsavePost(String postId, BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Remove Saved Post', style: TextStyle(color: Colors.white)),
        content: const Text(
  ...
  void _shareSavedPost(Map<String, dynamic> savedData, BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF1E293B),
        title: const Text('Share Saved Post', style: TextStyle(color: Colors.white)),
        content: Text(
  ...
  // ✅ FIXED: Added Log Out in Quick Menu + Scrollable on desktop
